...
class AdminType : UserType {
    ...
    override val userManagementStrategy = DynamicUserManagementStrategy(canCreate = true, canSearch = true, canGenerateReport = true, canGeneratePayment = true)
